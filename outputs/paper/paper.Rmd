...
Below contains a summary of the variables of interest using vtable[@vtable] and kableExtra[@kableExtra]:

```{r fig0, warning=FALSE, fig.cap="Summary of US GSS Variables", message = FALSE, echo=FALSE, fig.width=5, fig.height=5}
gss2021 <- gss2021 %>% 
