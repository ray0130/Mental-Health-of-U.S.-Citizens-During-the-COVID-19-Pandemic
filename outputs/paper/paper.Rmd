---
title: "What are the contributing factors to poor mental health in U.S?"
...
To get better insights on what factors affect Mental health for different parts of the population, we utilized the 2021 US General Social Survey [@norc] from NORC at the University of Chicago [@norc-at-the-university-of-chicago]. The raw dataset is a Stata file and was imported in R using the package Haven. It includes data from 568 Survey Questions for 4032 Survey Participants. Using the R [@citeR] package tidyverse [@citetidyverse] and dplyr [@dplyr], we were able to clean and perform exploratory data analysis on the dataset to get insights into the data. Further, we used R package ggplot2 [@citeggplot2] to visualize the data for this paper. 
...
Using a number of responses through the survey, we are able to observe the results visually using ggplot [@citeggplot2]; aiding in the understanding of the results. 
...
This displays a pattern, that males and females have nearly identical percentages for their physical health; given poor mental health.
...
![QR Code for the survey](C:/Users/Isfan/Desktop/Supplemental Survey Screen Shots/QR CODE.png){width=20% height=20%}\

The following images show the screenshots of the online survey form:


```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('C:/Users/Isfan/Desktop/Supplemental Survey Screen Shots/001.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('C:/Users/Isfan/Desktop/Supplemental Survey Screen Shots/002.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('C:/Users/Isfan/Desktop/Supplemental Survey Screen Shots/003.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('C:/Users/Isfan/Desktop/Supplemental Survey Screen Shots/004.png')
```
