...
knitr::include_graphics('("../../outputs/paper/supplemental survey/001.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('("../../outputs/paper/supplemental survey/002.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('("../../outputs/paper/supplemental survey/003.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('("../../outputs/paper/supplemental survey/004.png')
```
