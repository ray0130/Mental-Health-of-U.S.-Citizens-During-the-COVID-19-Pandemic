...
![QR Code for the survey](supplemental_survey/QR_CODE.png){width=20% height=20%}\

The following images show the screenshots of the online survey form:


```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('supplemental_survey/001.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('supplemental_survey/002.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('supplemental_survey/003.png')
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics('supplemental_survey/004.png')
```
